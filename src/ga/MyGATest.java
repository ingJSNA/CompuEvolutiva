...
public class MyGATest {
	...
	public static void real() {
		...
		// minimizing, add the parameter false if maximizing
		...
		PopulationSearch<double[], Double> search = factory.generational_ga(POPSIZE,
				new Tournament<double[]>(4), mutation, xover, 0.0, MAXITERS);
	...
	public static void schemeTheorem() {
		...
		Goal<BitArray, Double> goal = new OptimizationGoal<BitArray>(function, false); // maximizing,
																						// remove
																						// the
																						// parameter
																						// false if
	...
	public static void binary2real() {
		...
		int MAXITERS = 10;
		EAFactory<BitArray> factory = new EAFactory<BitArray>();
		PopulationSearch<BitArray, Double> bin_search = factory.generational_ga(POPSIZE,
				new Tournament<BitArray>(4), mutation, xover, 0.6, MAXITERS);
